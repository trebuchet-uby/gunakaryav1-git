...
<!--EDIT FORM TARUH SINI -->
					...
					<div id="content-wrapper">
						...
						<h2 class="mt-4">DATA PENGGUNA AIR</h2>
						<div align="justify">
							<p>
				...
				<!-- DataTables -->
							<div class="card mb-3">
								<div class="card-header">
									<a href="<?php echo site_url('admin/pamsimas/add') ?>">
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-hover" id="datatablesSimple" width="100%" cellspacing="0">
											...
											<tbody>
												<?php foreach ($pamsimass as $pamsimas): ?>
													<tr>
														<td width="150">
															<?php echo $pamsimas->id_pelanggan ?>
														</td>
														<td>
															<?php echo $pamsimas->nama ?>
														</td>
														<td>
															<?php echo $pamsimas->alamat ?>															
														</td>
														<td>
															<?php echo $pamsimas->nik ?>	
														</td>
														<td>
															<?php echo $pamsimas->langganan ?>	
														</td>
														<td width="250">
															<a href="<?php echo site_url('admin/pamsimas/edit/'.$pamsimas->id_pelanggan) ?>"
															class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
															<a onclick="deleteConfirm('<?php echo site_url('admin/pamsimas/delete/'.$pamsimas->id_pelanggan) ?>')"
